...
public class BGamesApi {
    ...
    private static final String API_GET_BASE_URL = new BGamesApiConfigsModel().getFullGetPath();
    private static final String API_USER_BASE_URL =new BGamesApiConfigsModel().getFullUserPath();
    private static final String API_POST_BASE_URL =new BGamesApiConfigsModel().getFullPostPath();;
    ...
    public int getAttributeIdByName(String attribute_name) {
        ...
        int id = new Utils().getIdAttributeFromJson(requestResponse.getResponse(),attribute_name);
    ...
    /**
     * Obtain the user of a player
     * @param player_id Idof player to spent points
    ...
    public ApiResponse spendAttribute(int player_id,String attribute_name,int amount_spent ) {
        ...
        int available_points= new Utils().getDataPlayerAttributeFromJson(data.getResponse(),attribute_name);
