...
public class BGamesAttributesAfectiveValueProcedure {
	public static String execute(Entity entity) {
		...
		double points = 0;
		points = (entity.getCapability(BgamesLibraryModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new BgamesLibraryModVariables.PlayerVariables())).bgames_afective_points;
		if (points == -1) {
			points = 0;
		}
